...
export default function Map() {
  ...
  const locations = [
    {
      name: "Відділення м.Тернопіль, вул 15 квітня 9",
      coords: [49.56021626518944, 25.643396004891258]
    },
    {
      name: "Відділення м.Тернопіль, вул Слівенська 3",
      coords: [49.54921968560542, 25.62172246507542]
    },
    {
      name: "Відділення м.Тернопіль, вул Злуки 8",
      coords: [49.56068897907157, 25.618684874265696]
    },
    {
      name: "Відділення м.Збараж, м-н І.Франка, 8",
      coords: [49.66163700617407, 25.77750227116415]
    },
    {
      name: "Відділення м.Підволочиськ, вул. Шевченка 4а",
      coords: [49.52787210243211, 26.1435181]
    }
  ];
